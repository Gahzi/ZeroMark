...
public class MineLayer : ProjectileAbilityBaseScript
{
    #region CONSTANTS

    public static float COOLDOWN_0 = 0.2500f;
    public static int RANGE_0 = 50;
    public static float RELOAD_TIME_0 = 30.0f;
    ...
    public static float COOLDOWN_1 = 0.2500f;
    public static int RANGE_1 = 50;
    public static float RELOAD_TIME_1 = 25.0f;
    ...
    public static float COOLDOWN_2 = 0.2500f;
    public static int RANGE_2 = 50;
    public static float RELOAD_TIME_2 = 20.0f;
    ...
    public override void Start()
    {
        projectileType = new ProjectileBaseScript[3]
        {
            ...
            (ProjectileBaseScript)Resources.Load(ObjectConstants.PREFAB_NAMES[ObjectConstants.type.MineLevel1], typeof(ProjectileBaseScript)),
            (ProjectileBaseScript)Resources.Load(ObjectConstants.PREFAB_NAMES[ObjectConstants.type.MineLevel2], typeof(ProjectileBaseScript))
        };
